...
- Each software should have its own requirements document.
- Each software should be tested against its requirements document. Test reports should be generated.
